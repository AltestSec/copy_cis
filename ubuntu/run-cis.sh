...
echo "CIS UBUNTU LINUX Benchmark (v2.2.0 - 12-27-2017)"
echo
...
test_wrapper 1.5.4 "Ensure prelink is not installed (Scored)" Yes Server1 Workstation1
test_wrapper 1.6.3 "Ensure SELinux and AppArmor is installed (Scored)" Yes Server2 Workstation2
test_wrapper 2.1.11 "Ensure the openbsd-inetd is not installed (Scored)" Yes Server2 Workstation2
...
test_wrapper 5.1.6 "Ensure permissions on /etc/cron.mothly are configured (Scored)" Yes Server1 Workstation1
